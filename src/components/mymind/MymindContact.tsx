              ...
              {[
                {
                  ...
                  icon: Mail,
                  label: "Email Address",
                  value: "support@neomindstechhub.com",
                ...
                },
                {
                  ...
                  value: "Office Space No. 704, 7th Floor, 5-9-59 & 60, Moguls Court Building, Basheerbagh, Hyderabad-500001, Telangana State",
                  delay: 0.2,
                },
              ].map((item) => {
