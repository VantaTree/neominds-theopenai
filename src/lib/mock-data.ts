...
export type Status =
  "Completed" | "In Progress" | "Pending" | "On Hold" | "Cancelled";
...
export const projects: Project[] = [
  {
    ...
    plan: "Plus",
    description:
      "Complete website redesign with modern UI/UX, responsive design and full marketing campaign including social media and email marketing.",
  ...
  },
  {
    ...
    website: "www.xyzagency.com",
    joinedOn: "May 14, 2024",
    plan: "Pro",
    description: "Brand-new website with portfolio showcase.",
    notes: "",
    serviceGroups: baseServiceGroups(),
  },
  {
    ...
    joinedOn: "May 12, 2024",
    plan: "Plus",
    description: "Multi-channel marketing campaign for summer collection.",
    notes: "",
    serviceGroups: baseServiceGroups(),
  },
  {
    ...
    joinedOn: "May 11, 2024",
    plan: "Basic",
    description: "SaaS landing page and B2B campaign.",
    notes: "",
    serviceGroups: baseServiceGroups(),
  },
  {
    ...
    joinedOn: "May 10, 2024",
    plan: "Pro",
    description: "Agency website refresh.",
    notes: "",
    serviceGroups: baseServiceGroups(),
  },
  {
    ...
    joinedOn: "May 9, 2024",
    plan: "Plus",
    description: "Awareness campaign for healthcare services.",
    notes: "",
    serviceGroups: baseServiceGroups(),
  },
  {
    ...
    joinedOn: "May 8, 2024",
    plan: "Plus",
    description: "Property listings site with SEO.",
    notes: "",
    serviceGroups: baseServiceGroups(),
  },
];
