            ...
            {showCalendarModal ? (
              ...
              <>
                ...
                <div className="flex justify-between items-center px-6 py-2.5 border-t shrink-0 z-30 bg-white text-zinc-900 border-gray-100">
                  ...
                  <button
                    className={`transition-all hover:scale-110 active:scale-95 flex items-center justify-center p-1 ${
                      hasContent ? "text-mm-orange" : "text-current hover:scale-105"
                    }`}
                    onClick={hasContent ? handleSaveClick : () => fileInputRef.current?.click()}
                    title={hasContent ? "Save Reel" : "Add Reel Video"}
                  >
                    {hasContent ? (
